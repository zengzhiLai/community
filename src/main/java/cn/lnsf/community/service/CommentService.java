...
import cn.lnsf.community.mapper.*;
import cn.lnsf.community.model.*;
...
public class CommentService {
    ...
    public void insert(Comment comment, User commentator) {
        ...
        if (comment.getType() == CommentTypeEnum.COMMENT.getType()) {
            ...
            // 创建通知
            createNotify(comment, commentator.getName(), NotificationTypeEnum.REPLY_COMMENT, question.getTitle(), dbComment.getCommentator(), question.getId());
            ...
            // 创建通知
            createNotify(comment, commentator.getName(), NotificationTypeEnum.REPLY_QUESTION, question.getTitle(), question.getCreator(), question.getId());
        }
     ...
     * @param outerId
     */
    private void createNotify(Comment comment, String notifierName, NotificationTypeEnum notificationTypeEnum, String outTitle, Long receiver, Long outerId) {
